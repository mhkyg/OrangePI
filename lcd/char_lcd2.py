...
class OrangePiZero_CharLCD(object):
    ...
    def __init__(self, rs, en, d4, d5, d6, d7, cols, lines, backlight=None,
        ...
        if backlight is not None:
            if enable_pwm:
                ...
                gpio.setcfg(backlight, gpio.OUTPUT)
    ...
    def write8(self, value, char_mode=False):
        ...
        """
        self._gpio.output(self._d4,((value >> 4) & 1) > 0)
        self._gpio.output(self._d5,((value >> 5) & 1) > 0)
        self._gpio.output(self._d6,((value >> 6) & 1) > 0)
        self._gpio.output(self._d7,((value >> 7) & 1) > 0)                                 
        self._pulse_enable()
        # Write lower 4 bits.
        ...
        """
        self._gpio.output(self._d4,(value        & 1) > 0)
        self._gpio.output(self._d5,((value >> 1) & 1) > 0)
        self._gpio.output(self._d6,((value >> 2) & 1) > 0)
        self._gpio.output(self._d7,((value >> 3) & 1) > 0)                                 
